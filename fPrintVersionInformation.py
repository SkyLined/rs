...
def fPrintVersionInformation(bCheckForUpdates = True):
  oMainProductDetails = mProductDetails.cProductDetails.foGetForProductName(gsMainProductName);
  aoAllLoadedProductDetails = oMainProductDetails.faoGetAllLoadedProductDetails();
  if bCheckForUpdates:
